		...
		<div class="main-panel">
			...
			<nav class="navbar navbar-expand-lg " color-on-scroll="500">
				<div class=" container-fluid">
					<a class="navbar-brand" href="<?= base_url() ?>"> Absensi </a>
				...
				<div class="container">
					<nav>
						<p class="copyright text-center">
							&copy; 2023 <a href="<?php base_url()?>">Botanica Laundry</a>
						</p>
					</nav>
				</div>
			</footer>
...
<script>
        function prepareReviewForm(nama, id_cuti) {
            // Set the value of the hidden input in the modal form
            document.getElementById('modalMobilInput').value = nama;
            document.getElementById('modalidInput').value = id_cuti;
        }
</script>
